...
type ServerConfig struct {
	...
	Port         string `mapstructure:"port"`          // Port specifies the AmneziaWG listening port.
	PrivateKey   string `mapstructure:"private_key"`   // PrivateKey is the AmneziaWG private key.

	Obfs Obfs `mapstructure:"obfs"` // Obfs holds the interface-level obfuscation parameters.
}
