...
// Client represents the AmneziaWG client service instance.
type Client struct {
...
// WithDevice sets the AmneziaWG network interface name and returns the updated Client instance.
...
// Setup prepares the AmneziaWG client service for operation.
...
// Start starts the AmneziaWG client service.
...
// Stop stops the AmneziaWG client service.
...
// Statistics retrieves the latest transfer statistics from the AmneziaWG interface.
